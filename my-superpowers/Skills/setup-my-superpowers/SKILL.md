...
description: Use when running setup-skills command to inject my-superpowers triggers into a target project's AGENTS.md and generate project-level code-review subagent + rule
---
